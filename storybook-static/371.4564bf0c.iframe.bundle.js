/*! For license information please see 371.4564bf0c.iframe.bundle.js.LICENSE.txt */
;(self.webpackChunknext_template = self.webpackChunknext_template || []).push([
	[371],
	{
		'./node_modules/.pnpm/axe-core@4.5.1/node_modules/axe-core/axe.js': function (
			module,
			exports,
			__webpack_require__,
		) {
				...
				!(function () {
					var __create = Object.create,
						...
						__require = __webpack_require__(
							'./node_modules/.pnpm/axe-core@4.5.1/node_modules/axe-core sync recursive',
						),
						...
						__toESM = function __toESM(mod, isNodeMode, target) {
							return (
								...
								(function __copyProps(to, from, except, desc) {
									if ((from && 'object' === _typeof(from)) || 'function' == typeof from) {
										var _step,
											_iterator = _createForOfIteratorHelper(__getOwnPropNames(from))
										try {
						...
						require_utils = __commonJS({
							'node_modules/css-selector-parser/lib/utils.js':
								function node_modulesCssSelectorParserLibUtilsJs(exports) {
									'use strict'
						...
						require_parser_context = __commonJS({
							'node_modules/css-selector-parser/lib/parser-context.js':
								function node_modulesCssSelectorParserLibParserContextJs(exports) {
									'use strict'
									Object.defineProperty(exports, '__esModule', { value: !0 })
									...
									exports.parseCssSelector = function parseCssSelector(
										...
										function getIdent() {
											...
											for (chr = str.charAt(pos); pos < l; ) {
												if (utils_1.isIdent(chr)) result += chr
													...
													if (((chr = str.charAt(pos)), utils_1.identSpecialChars[chr]))
														result += chr
													else {
														if (utils_1.isHex(chr)) {
															var hex = chr
										...
										function parseRule() {
											for (var rule = null; pos < l; )
												if ('*' === (chr = str.charAt(pos)))
													pos++, ((rule = rule || {}).tagName = '*')
												else if (utils_1.isIdentStart(chr) || '\\' === chr)
													(rule = rule || {}).tagName = getIdent()
												else if ('.' === chr)
													pos++,
														((rule = rule || {}).classNames = rule.classNames || []).push(
															getIdent(),
														)
													...
													if ('(' === chr) {
														...
														if ((skipWhitespace(), 'selector' === pseudos[pseudoName]))
															...
															if (
																((pseudo.valueType = pseudos[pseudoName] || 'string'), '"' === chr)
															)
						...
						require_render = __commonJS({
							'node_modules/css-selector-parser/lib/render.js':
								function node_modulesCssSelectorParserLibRenderJs(exports) {
									'use strict'
									Object.defineProperty(exports, '__esModule', { value: !0 })
									var utils_1 = require_utils()
											...
											case 'rule':
												entity.tagName &&
													(res =
														'*' === entity.tagName
															? '*'
															: utils_1.escapeIdentifier(entity.tagName)),
						...
						require_lib = __commonJS({
							'node_modules/css-selector-parser/lib/index.js':
								function node_modulesCssSelectorParserLibIndexJs(exports) {
									'use strict'
									Object.defineProperty(exports, '__esModule', { value: !0 })
						...
						require_noop = __commonJS({
							'node_modules/es5-ext/function/noop.js': function node_modulesEs5ExtFunctionNoopJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is_value = __commonJS({
							'node_modules/es5-ext/object/is-value.js': function node_modulesEs5ExtObjectIsValueJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_normalize_options = __commonJS({
							'node_modules/es5-ext/object/normalize-options.js':
								function node_modulesEs5ExtObjectNormalizeOptionsJs(exports, module) {
									'use strict'
						...
						require_is_implemented = __commonJS({
							'node_modules/es5-ext/math/sign/is-implemented.js':
								function node_modulesEs5ExtMathSignIsImplementedJs(exports, module) {
									'use strict'
									module.exports = function () {
										var sign = Math.sign
						...
						require_shim = __commonJS({
							'node_modules/es5-ext/math/sign/shim.js': function node_modulesEs5ExtMathSignShimJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_sign = __commonJS({
							'node_modules/es5-ext/math/sign/index.js': function node_modulesEs5ExtMathSignIndexJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_to_integer = __commonJS({
							'node_modules/es5-ext/number/to-integer.js':
								function node_modulesEs5ExtNumberToIntegerJs(exports, module) {
									'use strict'
									...
									module.exports = function (value) {
										return isNaN(value)
											...
											? sign(value) * floor2(abs(value))
											: value
									}
								},
						}),
						require_to_pos_integer = __commonJS({
							'node_modules/es5-ext/number/to-pos-integer.js':
								function node_modulesEs5ExtNumberToPosIntegerJs(exports, module) {
									'use strict'
						...
						require_resolve_length = __commonJS({
							'node_modules/memoizee/lib/resolve-length.js':
								function node_modulesMemoizeeLibResolveLengthJs(exports, module) {
									'use strict'
						...
						require_valid_callable = __commonJS({
							'node_modules/es5-ext/object/valid-callable.js':
								function node_modulesEs5ExtObjectValidCallableJs(exports, module) {
									'use strict'
						...
						require_valid_value = __commonJS({
							'node_modules/es5-ext/object/valid-value.js':
								function node_modulesEs5ExtObjectValidValueJs(exports, module) {
									'use strict'
									var isValue = require_is_value()
									module.exports = function (value) {
						...
						require_iterate = __commonJS({
							'node_modules/es5-ext/object/_iterate.js':
								function node_modulesEs5ExtObject_iterateJs(exports, module) {
									'use strict'
						...
						require_for_each = __commonJS({
							'node_modules/es5-ext/object/for-each.js': function node_modulesEs5ExtObjectForEachJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_registered_extensions = __commonJS({
							'node_modules/memoizee/lib/registered-extensions.js':
								function node_modulesMemoizeeLibRegisteredExtensionsJs() {},
						}),
						require_is_implemented2 = __commonJS({
							'node_modules/es5-ext/object/assign/is-implemented.js':
								function node_modulesEs5ExtObjectAssignIsImplementedJs(exports, module) {
									'use strict'
									module.exports = function () {
										var obj,
						...
						require_is_implemented3 = __commonJS({
							'node_modules/es5-ext/object/keys/is-implemented.js':
								function node_modulesEs5ExtObjectKeysIsImplementedJs(exports, module) {
									'use strict'
									module.exports = function () {
										try {
						...
						require_shim2 = __commonJS({
							'node_modules/es5-ext/object/keys/shim.js':
								function node_modulesEs5ExtObjectKeysShimJs(exports, module) {
									'use strict'
									var isValue = require_is_value(),
										keys = Object.keys
						...
						require_keys = __commonJS({
							'node_modules/es5-ext/object/keys/index.js':
								function node_modulesEs5ExtObjectKeysIndexJs(exports, module) {
									'use strict'
									module.exports = require_is_implemented3()() ? Object.keys : require_shim2()
								},
						}),
						require_shim3 = __commonJS({
							'node_modules/es5-ext/object/assign/shim.js':
								function node_modulesEs5ExtObjectAssignShimJs(exports, module) {
									'use strict'
						...
						require_assign = __commonJS({
							'node_modules/es5-ext/object/assign/index.js':
								function node_modulesEs5ExtObjectAssignIndexJs(exports, module) {
									'use strict'
						...
						require_is_object = __commonJS({
							'node_modules/es5-ext/object/is-object.js':
								function node_modulesEs5ExtObjectIsObjectJs(exports, module) {
									'use strict'
									var isValue = require_is_value(),
						...
						require_custom = __commonJS({
							'node_modules/es5-ext/error/custom.js': function node_modulesEs5ExtErrorCustomJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_mixin = __commonJS({
							'node_modules/es5-ext/object/mixin.js': function node_modulesEs5ExtObjectMixinJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_define_length = __commonJS({
							'node_modules/es5-ext/function/_define-length.js':
								function node_modulesEs5ExtFunction_defineLengthJs(exports, module) {
									'use strict'
									var desc,
										defineProperty,
										generate,
						...
						require_is2 = __commonJS({
							'node_modules/type/object/is.js': function node_modulesTypeObjectIsJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is3 = __commonJS({
							'node_modules/type/prototype/is.js': function node_modulesTypePrototypeIsJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is4 = __commonJS({
							'node_modules/type/function/is.js': function node_modulesTypeFunctionIsJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is5 = __commonJS({
							'node_modules/type/plain-function/is.js': function node_modulesTypePlainFunctionIsJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is_implemented4 = __commonJS({
							'node_modules/es5-ext/string/#/contains/is-implemented.js':
								function node_modulesEs5ExtStringContainsIsImplementedJs(exports, module) {
									'use strict'
									var str = 'razdwatrzy'
									module.exports = function () {
										return (
						...
						require_shim4 = __commonJS({
							'node_modules/es5-ext/string/#/contains/shim.js':
								function node_modulesEs5ExtStringContainsShimJs(exports, module) {
									'use strict'
						...
						require_contains = __commonJS({
							'node_modules/es5-ext/string/#/contains/index.js':
								function node_modulesEs5ExtStringContainsIndexJs(exports, module) {
									'use strict'
						...
						require_event_emitter = __commonJS({
							'node_modules/event-emitter/index.js': function node_modulesEventEmitterIndexJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is_implemented5 = __commonJS({
							'node_modules/es5-ext/array/from/is-implemented.js':
								function node_modulesEs5ExtArrayFromIsImplementedJs(exports, module) {
									'use strict'
									module.exports = function () {
										var arr,
											result,
						...
						require_is_implemented6 = __commonJS({
							'node_modules/ext/global-this/is-implemented.js':
								function node_modulesExtGlobalThisIsImplementedJs(exports, module) {
									'use strict'
									module.exports = function () {
										return (
											'object' ===
						...
						require_implementation = __commonJS({
							'node_modules/ext/global-this/implementation.js':
								function node_modulesExtGlobalThisImplementationJs(exports, module) {
						...
						require_global_this = __commonJS({
							'node_modules/ext/global-this/index.js': function node_modulesExtGlobalThisIndexJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is_implemented7 = __commonJS({
							'node_modules/es6-symbol/is-implemented.js':
								function node_modulesEs6SymbolIsImplementedJs(exports, module) {
									'use strict'
									var global2 = require_global_this(),
										validTypes = { object: !0, symbol: !0 }
									module.exports = function () {
										var symbol,
											Symbol2 = global2.Symbol
										if ('function' != typeof Symbol2) return !1
										...
										return (
											!!validTypes[_typeof(Symbol2.iterator)] &&
											!!validTypes[_typeof(Symbol2.toPrimitive)] &&
											!!validTypes[_typeof(Symbol2.toStringTag)]
										)
									}
								},
						}),
						require_is_symbol = __commonJS({
							'node_modules/es6-symbol/is-symbol.js': function node_modulesEs6SymbolIsSymbolJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_validate_symbol = __commonJS({
							'node_modules/es6-symbol/validate-symbol.js':
								function node_modulesEs6SymbolValidateSymbolJs(exports, module) {
									'use strict'
						...
						require_generate_name = __commonJS({
							'node_modules/es6-symbol/lib/private/generate-name.js':
								function node_modulesEs6SymbolLibPrivateGenerateNameJs(exports, module) {
									'use strict'
									var d = require_d(),
										create = Object.create,
										defineProperty = Object.defineProperty,
						...
						require_standard_symbols = __commonJS({
							'node_modules/es6-symbol/lib/private/setup/standard-symbols.js':
								function node_modulesEs6SymbolLibPrivateSetupStandardSymbolsJs(exports, module) {
									'use strict'
									var d = require_d(),
						...
						require_symbol_registry = __commonJS({
							'node_modules/es6-symbol/lib/private/setup/symbol-registry.js':
								function node_modulesEs6SymbolLibPrivateSetupSymbolRegistryJs(exports, module) {
									'use strict'
									var d = require_d(),
						...
						require_polyfill = __commonJS({
							'node_modules/es6-symbol/polyfill.js': function node_modulesEs6SymbolPolyfillJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_es6_symbol = __commonJS({
							'node_modules/es6-symbol/index.js': function node_modulesEs6SymbolIndexJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_is_arguments = __commonJS({
							'node_modules/es5-ext/function/is-arguments.js':
								function node_modulesEs5ExtFunctionIsArgumentsJs(exports, module) {
									'use strict'
						...
						require_is_function = __commonJS({
							'node_modules/es5-ext/function/is-function.js':
								function node_modulesEs5ExtFunctionIsFunctionJs(exports, module) {
									'use strict'
									var objToString = Object.prototype.toString,
									...
									module.exports = function (value) {
										return (
											'function' == typeof value && isFunctionStringTag(objToString.call(value))
										)
									}
								},
						}),
						require_is_string = __commonJS({
							'node_modules/es5-ext/string/is-string.js':
								function node_modulesEs5ExtStringIsStringJs(exports, module) {
									'use strict'
									var objToString = Object.prototype.toString,
										id = objToString.call('')
									module.exports = function (value) {
						...
						require_shim5 = __commonJS({
							'node_modules/es5-ext/array/from/shim.js': function node_modulesEs5ExtArrayFromShimJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_from = __commonJS({
							'node_modules/es5-ext/array/from/index.js':
								function node_modulesEs5ExtArrayFromIndexJs(exports, module) {
									'use strict'
									module.exports = require_is_implemented5()() ? Array.from : require_shim5()
								},
						}),
						require_to_array = __commonJS({
							'node_modules/es5-ext/array/to-array.js': function node_modulesEs5ExtArrayToArrayJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_resolve_resolve = __commonJS({
							'node_modules/memoizee/lib/resolve-resolve.js':
								function node_modulesMemoizeeLibResolveResolveJs(exports, module) {
									'use strict'
									var resolveArgs,
						...
						require_resolve_normalize = __commonJS({
							'node_modules/memoizee/lib/resolve-normalize.js':
								function node_modulesMemoizeeLibResolveNormalizeJs(exports, module) {
									'use strict'
									var callable = require_valid_callable()
						...
						require_configure_map = __commonJS({
							'node_modules/memoizee/lib/configure-map.js':
								function node_modulesMemoizeeLibConfigureMapJs(exports, module) {
									'use strict'
										...
										return (
											...
											(conf = {
												...
												get: function get(args) {
													return (
														resolve && (args = resolve(args)), _get ? _get(args) : String(args[0])
													)
												},
												has: function has(id) {
						...
						require_plain = __commonJS({
							'node_modules/memoizee/plain.js': function node_modulesMemoizeePlainJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_primitive = __commonJS({
							'node_modules/memoizee/normalizers/primitive.js':
								function node_modulesMemoizeeNormalizersPrimitiveJs(exports, module) {
									'use strict'
						...
						require_get_primitive_fixed = __commonJS({
							'node_modules/memoizee/normalizers/get-primitive-fixed.js':
								function node_modulesMemoizeeNormalizersGetPrimitiveFixedJs(exports, module) {
									'use strict'
						...
						require_is_implemented8 = __commonJS({
							'node_modules/es5-ext/number/is-nan/is-implemented.js':
								function node_modulesEs5ExtNumberIsNanIsImplementedJs(exports, module) {
									'use strict'
									module.exports = function () {
						...
						require_shim6 = __commonJS({
							'node_modules/es5-ext/number/is-nan/shim.js':
								function node_modulesEs5ExtNumberIsNanShimJs(exports, module) {
									'use strict'
									module.exports = function (value) {
										return value != value
									}
						...
						require_is_nan = __commonJS({
							'node_modules/es5-ext/number/is-nan/index.js':
								function node_modulesEs5ExtNumberIsNanIndexJs(exports, module) {
									'use strict'
									module.exports = require_is_implemented8()() ? Number.isNaN : require_shim6()
								},
						}),
						require_e_index_of = __commonJS({
							'node_modules/es5-ext/array/#/e-index-of.js':
								function node_modulesEs5ExtArrayEIndexOfJs(exports, module) {
									'use strict'
											...
											length = toPosInt(value(this).length),
												...
												i = fromIndex =
													isNaN(fromIndex)
														...
														: fromIndex >= 0
														? floor2(fromIndex)
														: toPosInt(this.length) - floor2(abs(fromIndex));
											i < length;
											++i
										)
						...
						require_get = __commonJS({
							'node_modules/memoizee/normalizers/get.js':
								function node_modulesMemoizeeNormalizersGetJs(exports, module) {
									'use strict'
						...
						require_get_1 = __commonJS({
							'node_modules/memoizee/normalizers/get-1.js':
								function node_modulesMemoizeeNormalizersGet1Js(exports, module) {
									'use strict'
									var indexOf = require_e_index_of()
									module.exports = function () {
										var lastId = 0,
						...
						require_get_fixed = __commonJS({
							'node_modules/memoizee/normalizers/get-fixed.js':
								function node_modulesMemoizeeNormalizersGetFixedJs(exports, module) {
									'use strict'
									var indexOf = require_e_index_of(),
										create = Object.create
									module.exports = function (length) {
						...
						require_map = __commonJS({
							'node_modules/es5-ext/object/map.js': function node_modulesEs5ExtObjectMapJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_next_tick = __commonJS({
							'node_modules/next-tick/index.js': function node_modulesNextTickIndexJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_primitive_set = __commonJS({
							'node_modules/es5-ext/object/primitive-set.js':
								function node_modulesEs5ExtObjectPrimitiveSetJs(exports, module) {
									'use strict'
						...
						require_is_callable = __commonJS({
							'node_modules/es5-ext/object/is-callable.js':
								function node_modulesEs5ExtObjectIsCallableJs(exports, module) {
									'use strict'
						...
						require_validate_stringifiable = __commonJS({
							'node_modules/es5-ext/object/validate-stringifiable.js':
								function node_modulesEs5ExtObjectValidateStringifiableJs(exports, module) {
									'use strict'
						...
						require_validate_stringifiable_value = __commonJS({
							'node_modules/es5-ext/object/validate-stringifiable-value.js':
								function node_modulesEs5ExtObjectValidateStringifiableValueJs(exports, module) {
									'use strict'
						...
						require_safe_to_string = __commonJS({
							'node_modules/es5-ext/safe-to-string.js': function node_modulesEs5ExtSafeToStringJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_to_short_string_representation = __commonJS({
							'node_modules/es5-ext/to-short-string-representation.js':
								function node_modulesEs5ExtToShortStringRepresentationJs(exports, module) {
									'use strict'
						...
						require_is_promise = __commonJS({
							'node_modules/is-promise/index.js': function node_modulesIsPromiseIndexJs(
								exports,
								module,
							) {
						...
						require_max_timeout = __commonJS({
							'node_modules/timers-ext/max-timeout.js': function node_modulesTimersExtMaxTimeoutJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_valid_timeout = __commonJS({
							'node_modules/timers-ext/valid-timeout.js':
								function node_modulesTimersExtValidTimeoutJs(exports, module) {
									'use strict'
									var toPosInt = require_to_pos_integer(),
						...
						require_lru_queue = __commonJS({
							'node_modules/lru-queue/index.js': function node_modulesLruQueueIndexJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_ref_counter = __commonJS({
							'node_modules/memoizee/ext/ref-counter.js':
								function node_modulesMemoizeeExtRefCounterJs() {
									'use strict'
									var d = require_d(),
										extensions = require_registered_extensions(),
										create = Object.create,
						...
						require_memoizee = __commonJS({
							'node_modules/memoizee/index.js': function node_modulesMemoizeeIndexJs(
								exports,
								module,
							) {
								'use strict'
						...
						require_doT = __commonJS({
							'node_modules/@deque/dot/doT.js': function node_modulesDequeDotDoTJs(
								exports,
								module,
							) {
								!(function () {
						...
						require_es6_promise = __commonJS({
							'node_modules/es6-promise/dist/es6-promise.js':
								function node_modulesEs6PromiseDistEs6PromiseJs(exports, module) {
									var factory
									;(factory = function () {
										'use strict'
										...
										scheduleFlush = isNode2
											...
											: void 0 === browserWindow && 'function' == typeof __require
										...
										var Enumerator = (function () {
												...
												return (
													...
													(Enumerator2.prototype._willSettleAt = function _willSettleAt(
														promise,
														i,
													) {
														var enumerator = this
							...
							'node_modules/typedarray/index.js': function node_modulesTypedarrayIndexJs(exports) {
								...
								function packIEEE754(v, ebits, fbits) {
									...
									for (
											...
											: ((s = v < 0),
											  (v = abs(v)) >= pow(2, 1 - bias)
													? ((e = min(floor2(log2(v) / LN2), 1023)),
													  (f = roundToEven((v / pow(2, e)) * pow(2, fbits))) / pow(2, fbits) >=
															2 && ((e += 1), (f = 1)),
													  e > bias
															? ((e = (1 << ebits) - 1), (f = 0))
										...
										bits.push(f % 2 ? 1 : 0), (f = floor2(f / 2))
									for (i = ebits; i; i -= 1) bits.push(e % 2 ? 1 : 0), (e = floor2(e / 2))
									for (
										...
										return (
											...
											(_ctor.prototype.set = function (index, value) {
												...
												if (
													...
													if (
														((array = arguments[0]),
														(offset = ECMAScript.ToUint32(arguments[1])) + array.length >
															this.length)
													)
						...
						require_weakmap_polyfill = __commonJS({
							'node_modules/weakmap-polyfill/weakmap-polyfill.js':
								function node_modulesWeakmapPolyfillWeakmapPolyfillJs(exports) {
									!(function (self2) {
										'use strict'
										if (!self2.WeakMap) {
											...
											self2.WeakMap = (function () {
												function WeakMap2() {
													...
													if (
														(defineProperty(this, '_id', genId('_WeakMap')), arguments.length > 0)
													)
					...
					var clone_default = function clone(obj) {
						...
						parser = new (__toESM(require_lib()).CssSelectorParser)()
					...
					var i,
						BufferClass = 'function' == typeof window.Buffer ? window.Buffer : Array,
						_byteToHex = [],
						_hexToByte = {}
					for (i = 0; i < 256; i++)
					...
					var find_up_default = function findUp(element, target) {
						...
						import_memoizee = __toESM(require_memoizee())
					axe._memoizedFns = []
					...
					function _createGrid() {
						...
						if ((cache_default.set('gridCreated', !0), !parentVNode)) {
							...
							if (
								...
								var subGrid = { container: vNode, cells: [] }
						...
						for (
							...
							if (_getScroll(_vNode.actualNode)) {
								var _subGrid = { container: _vNode, cells: [] }
					...
					function addNodeToGrid(grid, vNode) {
						...
						vNode.clientRects.forEach(function (rect) {
							...
							if (!(rect.right <= 0 || rect.bottom <= 0)) {
								...
								var x = rect.left,
									y = rect.top,
									startRow = (y / gridSize) | 0,
									startCol = (x / gridSize) | 0,
									endRow = ((y + rect.height) / gridSize) | 0,
									endCol = ((x + rect.width) / gridSize) | 0
								grid.numCols = Math.max(
									null !== (_grid$numCols = grid.numCols) && void 0 !== _grid$numCols
										? _grid$numCols
										: 0,
									endCol,
								)
								for (var row = startRow; row <= endRow; row++) {
									...
									for (var col = startCol; col <= endCol; col++)
										(grid.cells[row][col] = grid.cells[row][col] || []),
											grid.cells[row][col].includes(vNode) || grid.cells[row][col].push(vNode)
								}
							}
						})
					}
					...
					function loopGridCells(gridCells, boundaries, cb) {
						for (
							var topRow = boundaries.topRow,
								bottomRow = boundaries.bottomRow,
								leftCol = boundaries.leftCol,
								rightCol = boundaries.rightCol,
								row = topRow;
							row <= bottomRow;
							row++
						)
							for (var col = leftCol; col <= rightCol; col++)
								for (
									var _gridCells$row$col$le,
										_gridCells$row,
										_gridCells$row$col,
										length =
											null !==
												(_gridCells$row$col$le =
													null === (_gridCells$row = gridCells[row]) ||
													void 0 === _gridCells$row ||
													null === (_gridCells$row$col = _gridCells$row[col]) ||
													void 0 === _gridCells$row$col
														? void 0
														: _gridCells$row$col.length) && void 0 !== _gridCells$row$col$le
												? _gridCells$row$col$le
												: -1,
										_i5 = 0;
									_i5 < length;
					...
					function getRectStack(grid, rect) {
						var _grid$cells$row$col$f,
							_grid$cells$row$col,
							recursed = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
							x = rect.left + rect.width / 2,
							y = rect.top + rect.height / 2,
							floorX = floor(x),
							floorY = floor(y),
							row = floor(y / constants_default.gridSize),
							col = floor(x / constants_default.gridSize)
						if (row > grid.cells.length || col > grid.numCols)
							throw new Error('Element midpoint exceeds the grid bounds')
						var stack =
								null !==
									(_grid$cells$row$col$f =
										null === (_grid$cells$row$col = grid.cells[row][col]) ||
										void 0 === _grid$cells$row$col
											? void 0
											: _grid$cells$row$col.filter(function (gridCellNode) {
								...
								Array.from(node.childNodes).forEach(function (elm) {
									if (3 === elm.nodeType && '' !== sanitize_default(elm.textContent)) {
										...
										var rects = range.getClientRects(),
											outsideRectBounds = Array.from(rects).some(function (rect) {
												var horizontalMidpoint = rect.left + rect.width / 2,
													verticalMidpoint = rect.top + rect.height / 2
												return (
					...
					function hasChildTextNodes(elm) {
						return (
							...
							elm.children.some(function (_ref13) {
					...
					function _isMultiline(domNode) {
						...
						var _step2,
							lastLineEnd = 0,
							lineCount = 0,
							_iterator2 = _createForOfIteratorHelper(range.getClientRects())
						try {
					...
					var color_default = function Color(red, green, blue, alpha) {
						...
						;(this.parseString = function parseString(colorString) {
							...
							(this.parseColorFnString = function parseColorFnString(colorString) {
								var _ref19 = _slicedToArray(colorString.match(colorFnRegex) || [], 3),
									colorFunc = _ref19[1],
									colorValStr = _ref19[2]
								if (colorFunc && colorValStr) {
									...
									'hsl' === colorFunc.substr(0, 3) &&
										(colorNums = (function hslToRgb(_ref14) {
					...
					function isVisible(el, screenReader, recursed) {
						...
						var cacheName = '_isVisible' + (screenReader ? 'ScreenReader' : ''),
							_ref21 =
								null !== (_window$Node2 = window.Node) && void 0 !== _window$Node2
									? _window$Node2
									: {},
							DOCUMENT_NODE = _ref21.DOCUMENT_NODE,
							DOCUMENT_FRAGMENT_NODE = _ref21.DOCUMENT_FRAGMENT_NODE,
						...
						if ('area' === nodeName2)
							return (function isAreaVisible(el, screenReader, recursed) {
								...
								return (
									!(!refs || !refs.length) &&
									refs.some(function (_ref20) {
										return isVisible(_ref20.actualNode, screenReader, recursed)
									})
								)
																		...
																		node[type]
																			...
																			.forEach(function (checkRes) {
																				checkRes.relatedNodes = checkRes.relatedNodes.map(function (
																					...
																					var res = { html: relatedNode.source }
																					return (
																						options.elementRef &&
																							!relatedNode.fromFrame &&
																							(res.element = relatedNode.element),
																						(!1 !== options.selectors || relatedNode.fromFrame) &&
																							(res.target = relatedNode.selector),
																						options.ancestry &&
																							(res.ancestry = relatedNode.ancestry),
																						options.xpath && (res.xpath = relatedNode.xpath),
																						res
																					)
																				})
																			})
					...
					function createFrameContext(frame, _ref24) {
						var focusable = _ref24.focusable,
							page = _ref24.page
						return {
							node: frame,
							include: [],
					...
					function Context(spec, flatTree) {
						...
						;(spec = clone_default(spec)),
								...
								null != flatTree
									...
									: get_flattened_tree_default(
											(function getRootNode2(_ref26) {
												for (
													var include = _ref26.include,
														exclude = _ref26.exclude,
							...
							void 0 === this.page &&
								((this.page = (function isPageContext(_ref25) {
					...
					function _getFrameContexts(context) {
						...
						return frames.map(function (_ref27) {
							var node = _ref27.node,
								frameContext = _objectWithoutProperties(_ref27, _excluded2)
							return (
					...
					var preload_cssom_default = function preloadCssom(_ref28) {
						var _ref28$treeRoot = _ref28.treeRoot,
							...
							})(void 0 === _ref28$treeRoot ? axe._tree[0] : _ref28$treeRoot)
						...
						return (function getCssomForAllRootNodes(rootNodes, convertDataToStylesheet) {
							...
							return (
								rootNodes.forEach(function (_ref29, index) {
									var rootNode = _ref29.rootNode,
										shadowId = _ref29.shadowId,
					...
					var preload_media_default = function preloadMedia(_ref30) {
						var _ref30$treeRoot = _ref30.treeRoot,
							treeRoot = void 0 === _ref30$treeRoot ? axe._tree[0] : _ref30$treeRoot,
						...
						return Promise.all(
							mediaVirtualNodes.map(function (_ref32) {
					...
					var set_scroll_state_default = function setScrollState(scrollState) {
						scrollState.forEach(function (_ref34) {
							...
							})(_ref34.elm, _ref34.top, _ref34.left)
						})
					}
						...
						SerialVirtualNode = (function (_abstract_virtual_nod2) {
							...
							function SerialVirtualNode(serialNode) {
								...
								return (
												...
												null !==
													(_ref35 =
														...
														void 0 !== _serialNode$nodeType
															? _serialNode$nodeType
															: nodeNamesToTypes[serialNode.nodeName]) && void 0 !== _ref35
													? _ref35
													: 1
										assert_default(
									...
									(_this3._attrs = (function normaliseAttrs(_ref36) {
										var _ref36$attributes = _ref36.attributes,
											attributes2 = void 0 === _ref36$attributes ? {} : _ref36$attributes,
					...
					var import_css_selector_parser2 = __toESM(require_lib()),
						import_dot = __toESM(require_doT()),
						emoji_regex_default = function emoji_regex_default() {
							return /[#*0-9]\uFE0F?\u20E3|[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u267F\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26AA\u26B0\u26B1\u26BD\u26BE\u26C4\u26C8\u26CF\u26D1\u26D3\u26E9\u26F0-\u26F5\u26F7\u26F8\u26FA\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2757\u2763\u27A1\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B55\u3030\u303D\u3297\u3299]\uFE0F?|[\u261D\u270C\u270D](?:\uFE0F|\uD83C[\uDFFB-\uDFFF])?|[\u270A\u270B](?:\uD83C[\uDFFB-\uDFFF])?|[\u23E9-\u23EC\u23F0\u23F3\u25FD\u2693\u26A1\u26AB\u26C5\u26CE\u26D4\u26EA\u26FD\u2705\u2728\u274C\u274E\u2753-\u2755\u2795-\u2797\u27B0\u27BF\u2B50]|\u26F9(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|\u2764\uFE0F?(?:\u200D(?:\uD83D\uDD25|\uD83E\uDE79))?|\uD83C(?:[\uDC04\uDD70\uDD71\uDD7E\uDD7F\uDE02\uDE37\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF5\uDFF7]\uFE0F?|[\uDF85\uDFC2\uDFC7](?:\uD83C[\uDFFB-\uDFFF])?|[\uDFC3\uDFC4\uDFCA](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDFCB\uDFCC](?:\uFE0F|\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDCCF\uDD8E\uDD91-\uDD9A\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF7C\uDF7E-\uDF84\uDF86-\uDF93\uDFA0-\uDFC1\uDFC5\uDFC6\uDFC8\uDFC9\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF8-\uDFFF]|\uDDE6\uD83C[\uDDE8-\uDDEC\uDDEE\uDDF1\uDDF2\uDDF4\uDDF6-\uDDFA\uDDFC\uDDFD\uDDFF]|\uDDE7\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEF\uDDF1-\uDDF4\uDDF6-\uDDF9\uDDFB\uDDFC\uDDFE\uDDFF]|\uDDE8\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDEE\uDDF0-\uDDF5\uDDF7\uDDFA-\uDDFF]|\uDDE9\uD83C[\uDDEA\uDDEC\uDDEF\uDDF0\uDDF2\uDDF4\uDDFF]|\uDDEA\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDED\uDDF7-\uDDFA]|\uDDEB\uD83C[\uDDEE-\uDDF0\uDDF2\uDDF4\uDDF7]|\uDDEC\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEE\uDDF1-\uDDF3\uDDF5-\uDDFA\uDDFC\uDDFE]|\uDDED\uD83C[\uDDF0\uDDF2\uDDF3\uDDF7\uDDF9\uDDFA]|\uDDEE\uD83C[\uDDE8-\uDDEA\uDDF1-\uDDF4\uDDF6-\uDDF9]|\uDDEF\uD83C[\uDDEA\uDDF2\uDDF4\uDDF5]|\uDDF0\uD83C[\uDDEA\uDDEC-\uDDEE\uDDF2\uDDF3\uDDF5\uDDF7\uDDFC\uDDFE\uDDFF]|\uDDF1\uD83C[\uDDE6-\uDDE8\uDDEE\uDDF0\uDDF7-\uDDFB\uDDFE]|\uDDF2\uD83C[\uDDE6\uDDE8-\uDDED\uDDF0-\uDDFF]|\uDDF3\uD83C[\uDDE6\uDDE8\uDDEA-\uDDEC\uDDEE\uDDF1\uDDF4\uDDF5\uDDF7\uDDFA\uDDFF]|\uDDF4\uD83C\uDDF2|\uDDF5\uD83C[\uDDE6\uDDEA-\uDDED\uDDF0-\uDDF3\uDDF7-\uDDF9\uDDFC\uDDFE]|\uDDF6\uD83C\uDDE6|\uDDF7\uD83C[\uDDEA\uDDF4\uDDF8\uDDFA\uDDFC]|\uDDF8\uD83C[\uDDE6-\uDDEA\uDDEC-\uDDF4\uDDF7-\uDDF9\uDDFB\uDDFD-\uDDFF]|\uDDF9\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDED\uDDEF-\uDDF4\uDDF7\uDDF9\uDDFB\uDDFC\uDDFF]|\uDDFA\uD83C[\uDDE6\uDDEC\uDDF2\uDDF3\uDDF8\uDDFE\uDDFF]|\uDDFB\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDEE\uDDF3\uDDFA]|\uDDFC\uD83C[\uDDEB\uDDF8]|\uDDFD\uD83C\uDDF0|\uDDFE\uD83C[\uDDEA\uDDF9]|\uDDFF\uD83C[\uDDE6\uDDF2\uDDFC]|\uDFF3\uFE0F?(?:\u200D(?:\u26A7\uFE0F?|\uD83C\uDF08))?|\uDFF4(?:\u200D\u2620\uFE0F?|\uDB40\uDC67\uDB40\uDC62\uDB40(?:\uDC65\uDB40\uDC6E\uDB40\uDC67|\uDC73\uDB40\uDC63\uDB40\uDC74|\uDC77\uDB40\uDC6C\uDB40\uDC73)\uDB40\uDC7F)?)|\uD83D(?:[\uDC08\uDC26](?:\u200D\u2B1B)?|[\uDC3F\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3]\uFE0F?|[\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC6B-\uDC6D\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDC8F\uDC91\uDCAA\uDD7A\uDD95\uDD96\uDE4C\uDE4F\uDEC0\uDECC](?:\uD83C[\uDFFB-\uDFFF])?|[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDD74\uDD90](?:\uFE0F|\uD83C[\uDFFB-\uDFFF])?|[\uDC00-\uDC07\uDC09-\uDC14\uDC16-\uDC25\uDC27-\uDC3A\uDC3C-\uDC3E\uDC40\uDC44\uDC45\uDC51-\uDC65\uDC6A\uDC79-\uDC7B\uDC7D-\uDC80\uDC84\uDC88-\uDC8E\uDC90\uDC92-\uDCA9\uDCAB-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDDA4\uDDFB-\uDE2D\uDE2F-\uDE34\uDE37-\uDE44\uDE48-\uDE4A\uDE80-\uDEA2\uDEA4-\uDEB3\uDEB7-\uDEBF\uDEC1-\uDEC5\uDED0-\uDED2\uDED5-\uDED7\uDEDC-\uDEDF\uDEEB\uDEEC\uDEF4-\uDEFC\uDFE0-\uDFEB\uDFF0]|\uDC15(?:\u200D\uD83E\uDDBA)?|\uDC3B(?:\u200D\u2744\uFE0F?)?|\uDC41\uFE0F?(?:\u200D\uD83D\uDDE8\uFE0F?)?|\uDC68(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDC68\uDC69]\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFE])))?))?|\uDC69(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?[\uDC68\uDC69]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?|\uDC69\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?))|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFE])))?))?|\uDC6F(?:\u200D[\u2640\u2642]\uFE0F?)?|\uDD75(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|\uDE2E(?:\u200D\uD83D\uDCA8)?|\uDE35(?:\u200D\uD83D\uDCAB)?|\uDE36(?:\u200D\uD83C\uDF2B\uFE0F?)?)|\uD83E(?:[\uDD0C\uDD0F\uDD18-\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5\uDEC3-\uDEC5\uDEF0\uDEF2-\uDEF8](?:\uD83C[\uDFFB-\uDFFF])?|[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDDDE\uDDDF](?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDD0D\uDD0E\uDD10-\uDD17\uDD20-\uDD25\uDD27-\uDD2F\uDD3A\uDD3F-\uDD45\uDD47-\uDD76\uDD78-\uDDB4\uDDB7\uDDBA\uDDBC-\uDDCC\uDDD0\uDDE0-\uDDFF\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC2\uDECE-\uDEDB\uDEE0-\uDEE8]|\uDD3C(?:\u200D[\u2640\u2642]\uFE0F?|\uD83C[\uDFFB-\uDFFF])?|\uDDD1(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83E\uDDD1))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF-\uDDB3\uDDBC\uDDBD]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?))?|\uDEF1(?:\uD83C(?:\uDFFB(?:\u200D\uD83E\uDEF2\uD83C[\uDFFC-\uDFFF])?|\uDFFC(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFD-\uDFFF])?|\uDFFD(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])?|\uDFFE(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFD\uDFFF])?|\uDFFF(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFE])?))?)/g
						},
						import_memoizee2 = __toESM(require_memoizee()),
						import_es6_promise = __toESM(require_es6_promise()),
						import_typedarray = __toESM(require_typedarray())
					__toESM(require_weakmap_polyfill())
					...
					var is_valid_role_default = function isValidRole(role) {
						var _ref37 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							allowAbstract = _ref37.allowAbstract,
							_ref37$flagUnsupporte = _ref37.flagUnsupported,
							flagUnsupported = void 0 !== _ref37$flagUnsupporte && _ref37$flagUnsupporte,
					...
					var get_explicit_role_default = function getExplicitRole(vNode) {
						var _ref38 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							fallback = _ref38.fallback,
							abstracts = _ref38.abstracts,
							dpub = _ref38.dpub
						if (
							1 !==
							(vNode =
					...
					var get_element_spec_default = function getElementSpec(vNode) {
						var _ref39 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							_ref39$noMatchAccessi = _ref39.noMatchAccessibleName,
							noMatchAccessibleName = void 0 !== _ref39$noMatchAccessi && _ref39$noMatchAccessi,
					...
					var implicit_role_default = function implicitRole2(node) {
							var _ref40 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
								chromium = _ref40.chromium,
								vNode =
									node instanceof abstract_virtual_node_default
										? node
										: get_node_from_tree_default(node)
					...
					function resolveImplicitRole(vNode, _ref41) {
						var chromium = _ref41.chromium,
							explicitRoleOptions = _objectWithoutProperties(_ref41, _excluded5),
					...
					function resolveRole(node) {
						var _ref42 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							noImplicit = _ref42.noImplicit,
							roleOptions = _objectWithoutProperties(_ref42, _excluded6),
							vNode =
								node instanceof abstract_virtual_node_default
									? node
									: get_node_from_tree_default(node)
					...
					var get_role_default = function getRole(node) {
							var _ref43 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
								noPresentational = _ref43.noPresentational,
								options = _objectWithoutProperties(_ref43, _excluded7),
					...
					var named_from_contents_default = function namedFromContents(vNode) {
						var _ref44 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							strict = _ref44.strict
						if (
							1 !==
							(vNode =
								vNode instanceof abstract_virtual_node_default
					...
					var native_text_methods_default = {
						valueText: function valueText(_ref45) {
							return _ref45.actualNode.value || ''
						},
					...
					var is_valid_autocomplete_default = function isValidAutocomplete(autocompleteValue) {
						var _ref48 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							_ref48$looseTyped = _ref48.looseTyped,
							looseTyped = void 0 !== _ref48$looseTyped && _ref48$looseTyped,
							_ref48$stateTerms = _ref48.stateTerms,
							stateTerms = void 0 === _ref48$stateTerms ? [] : _ref48$stateTerms,
							_ref48$locations = _ref48.locations,
							locations = void 0 === _ref48$locations ? [] : _ref48$locations,
							_ref48$qualifiers = _ref48.qualifiers,
							qualifiers = void 0 === _ref48$qualifiers ? [] : _ref48$qualifiers,
							_ref48$standaloneTerm = _ref48.standaloneTerms,
							standaloneTerms = void 0 === _ref48$standaloneTerm ? [] : _ref48$standaloneTerm,
							_ref48$qualifiedTerms = _ref48.qualifiedTerms,
							qualifiedTerms = void 0 === _ref48$qualifiedTerms ? [] : _ref48$qualifiedTerms
						if (
					...
					;(lookupTable.role = {
						...
						(lookupTable.evaluateRoleForElement = {
							...
							MENU: function MENU(_ref55) {
								return 'context' !== _ref55.node.getAttribute('type')
							},
					...
					var aria_required_children_evaluate_default = function ariaRequiredChildrenEvaluate(
						...
						var ownedRoles = (function getOwnedRoles(virtualNode, required) {
							...
							unallowed = ownedRoles.filter(function (_ref59) {
						...
						if (unallowed.length)
							return (
								this.relatedNodes(
									unallowed.map(function (_ref60) {
										return _ref60.ownedElement
									}),
								),
					...
					function textShadowColor(_ref63) {
						var colorStr = _ref63.colorStr,
							offsetX = _ref63.offsetX,
							offsetY = _ref63.offsetY,
							blurRadius = _ref63.blurRadius,
							fontSize = _ref63.fontSize
						...
						return (
							...
							(shadowColor.alpha *= (function blurRadiusToAlpha(blurRadius, fontSize) {
								...
								return 0.185 / (blurRadius / fontSize + 0.4)
							})(blurRadius, fontSize)),
							shadowColor
						)
					}
					var get_text_shadow_colors_default = function getTextShadowColors(node) {
						var _ref61 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							minRatio = _ref61.minRatio,
							maxRatio = _ref61.maxRatio,
						...
						return (
							shadows.forEach(function (_ref62) {
								var colorStr = _ref62.colorStr,
									pixels = _ref62.pixels
					...
					function parseUnit(str) {
						var _ref67 = _slicedToArray(str.match(/^([0-9.]+)([a-z]+)$/i) || [], 3),
							_ref67$ = _ref67[1],
							value = void 0 === _ref67$ ? '' : _ref67$,
							_ref67$2 = _ref67[2],
							unit = void 0 === _ref67$2 ? '' : _ref67$2
					...
					var link_in_text_block_evaluate_default = function linkInTextBlockEvaluate(
							...
							if (parentBlock) {
								...
								if (textContrast && textContrast >= requiredContrastRatio) return !0
								var backgroundContrast =
									nodeBackgroundColor && parentBackgroundColor
										? getContrast2(nodeBackgroundColor, parentBackgroundColor)
										: void 0
								if (backgroundContrast && backgroundContrast >= requiredContrastRatio) return !0
					...
					var label_content_name_mismatch_evaluate_default =
						function labelContentNameMismatchEvaluate(node, options, virtualNode) {
							var _ref69 = options || {},
								pixelThreshold = _ref69.pixelThreshold,
								occuranceThreshold = _ref69.occuranceThreshold,
					...
					function getInvalidSelector(vChild, nested, _ref70) {
						var _ref70$validRoles = _ref70.validRoles,
							validRoles = void 0 === _ref70$validRoles ? [] : _ref70$validRoles,
							_ref70$validNodeNames = _ref70.validNodeNames,
							validNodeNames = void 0 === _ref70$validNodeNames ? [] : _ref70$validNodeNames,
					...
					var css_orientation_lock_evaluate_default = function cssOrientationLockEvaluate(
						...
						var _ref71$cssom = (context || {}).cssom,
							cssom = void 0 === _ref71$cssom ? void 0 : _ref71$cssom,
							_ref72$degreeThreshol = (options || {}).degreeThreshold,
							degreeThreshold = void 0 === _ref72$degreeThreshol ? 0 : _ref72$degreeThreshol
									...
									_loop6 = function _loop6() {
										...
										orientationRules.forEach(function (_ref73) {
											...
											Array.from(cssRules).forEach(function (cssRule) {
												var locked = (function getIsOrientationLocked(_ref76) {
					...
					var meta_viewport_scale_evaluate_default = function metaViewportScaleEvaluate(
							...
							var _ref79 = options || {},
								...
								scaleMinimum = void 0 === _ref79$scaleMinimum ? 2 : _ref79$scaleMinimum,
								_ref79$lowerBound = _ref79.lowerBound,
								lowerBound = void 0 !== _ref79$lowerBound && _ref79$lowerBound,
							...
							pointA = (function getFarthestPoint(rectA, rectB) {
								...
								return (
									[
										['x', 'left', 'right', 'width'],
										['y', 'top', 'bottom', 'height'],
									].forEach(function (_ref80) {
										var _ref81 = _slicedToArray(_ref80, 4),
											axis = _ref81[0],
											start = _ref81[1],
											end = _ref81[2],
											diameter = _ref81[3]
					...
					function _splitRects(outerRect, overlapRects) {
						...
						try {
							...
							for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) _loop7()
						} catch (err) {
							_iterator3.e(err)
						} finally {
							_iterator3.f()
					...
					function rectHasMinimumSize(minSize, _ref87) {
						var width = _ref87.width,
							height = _ref87.height
						return width + 0.05 >= minSize && height + 0.05 >= minSize
					}
					function mapActualNodes(vNodes) {
						return vNodes.map(function (_ref88) {
							return _ref88.actualNode
						})
					}
					...
					var identical_links_same_purpose_after_default = function identicalLinksSamePurposeAfter(
							...
							for (
								var incompleteResults = results.filter(function (_ref94) {
										return void 0 !== _ref94.result
									}),
									uniqueResults = [],
									nameMap = {},
									_loop8 = function _loop8(index) {
										...
										var sameNameResults = incompleteResults.filter(function (_ref95, resultNum) {
												return _ref95.data.name === name && resultNum !== index
											}),
											isSameUrl = sameNameResults.every(function (_ref96) {
												return isIdenticalObject(_ref96.data.urlProps, urlProps)
											})
								...
								results.forEach(function (r) {
									if (!r.result && 1 !== r.node.ancestry.length) {
										var _step6,
											...
											_iterator6 = _createForOfIteratorHelper(iframeResults)
										try {
											for (_iterator6.s(); !(_step6 = _iterator6.n()).done; ) {
												var iframeResult = _step6.value
					...
					function findRegionlessElms(virtualNode, options) {
						...
						return node !== document.body && has_content_default(node, !0)
							...
							: virtualNode.children
									.filter(function (_ref98) {
										return 1 === _ref98.actualNode.nodeType
									})
									.map(function (vNode) {
					...
					var svg_non_empty_title_evaluate_default = function svgNonEmptyTitleEvaluate(
						...
						if (virtualNode.children) {
							var titleNode = virtualNode.children.find(function (_ref100) {
								return 'title' === _ref100.props.nodeName
							})
					...
					var color_contrast_matches_default = function colorContrastMatches(node, virtualNode) {
						...
						for (var rects = range.getClientRects(), _index = 0; _index < rects.length; _index++)
							if (visually_overlaps_default(rects[_index], node)) return !0
						return !1
					}
					...
					var link_in_text_block_matches_default = function linkInTextBlockMatches(node) {
						var text = sanitize_default(node.textContent),
					...
					var metadataFunctionMap = {
									...
									var nodeStyle = window.getComputedStyle(node),
										...
										_ref64 =
											(bold && ptSize < boldTextPt) || (!bold && ptSize < largeTextPt)
												...
												: contrastRatio.large,
										expected = _ref64.expected,
										minThreshold = _ref64.minThreshold,
										maxThreshold = _ref64.maxThreshold,
										pseudoElm = (function findPseudoElement(vNode, _ref65) {
											var _ref65$pseudoSizeThre = _ref65.pseudoSizeThreshold,
												pseudoSizeThreshold =
													void 0 === _ref65$pseudoSizeThre ? 0.25 : _ref65$pseudoSizeThre,
												_ref65$ignorePseudo = _ref65.ignorePseudo
											if (void 0 !== _ref65$ignorePseudo && _ref65$ignorePseudo) return
											var rect = vNode.boundingClientRect,
							...
							'heading-order-after': function headingOrderAfter(results) {
								var headingOrder = (function getHeadingOrder(results) {
									return (
										(results = _toConsumableArray(results)).sort(function (_ref89, _ref90) {
											var nodeA = _ref89.node,
												nodeB = _ref90.node
											return nodeA.ancestry.length - nodeB.ancestry.length
										}),
										results.reduce(mergeHeadingOrder, []).filter(function (_ref91) {
											return -1 !== _ref91.level
										})
									)
								})(results)
								return (
							...
							'inline-style-property-evaluate': function inlineStyleProperty(node, options) {
								...
								var value = (function getNumberValue(domNode, _ref99) {
									var cssProperty = _ref99.cssProperty,
										absoluteValues = _ref99.absoluteValues,
										normalValue = _ref99.normalValue,
							...
							'meta-refresh-evaluate': function metaRefreshEvaluate(node, options, virtualNode) {
								var _ref97 = options || {},
									minDelay = _ref97.minDelay,
									maxDelay = _ref97.maxDelay,
							...
							'region-evaluate': function regionEvaluate(node, options, virtualNode) {
								...
								var regionlessNodes = cache_default.get('regionlessNodes', function () {
									return (function getRegionlessNodes(options) {
										return findRegionlessElms(axe._tree[0], options)
											.map(function (vNode) {
												for (
													;
													vNode.parent &&
							...
							'target-offset-evaluate': function targetOffsetEvaluate(node, options, vNode) {
								var _step4,
									...
									_iterator4 = _createForOfIteratorHelper(_findNearbyElms(vNode, minOffset))
								try {
								...
								return 0 === closeNeighbors.length
									...
									: (this.relatedNodes(
											closeNeighbors.map(function (_ref85) {
												return _ref85.actualNode
											}),
									  ),
							...
							'target-size-evaluate': function targetSize(node, options, vNode) {
								var minSize = (null == options ? void 0 : options.minSize) || 24,
									...
									_filterByElmsOverlap = (function filterByElmsOverlap(vNode, nearbyElms) {
										var _step5,
											...
											_iterator5 = _createForOfIteratorHelper(nearbyElms)
										try {
								...
								var obscuredWidgets = (function filterFocusableWidgets(vNodes) {
									...
									largestInnerRect = (function getLargestUnobscuredArea(vNode, obscuredNodes) {
										...
										var obscuringRects = obscuredNodes.map(function (_ref86) {
											return _ref86.boundingClientRect
										})
										...
										})(_splitRects(nodeRect, obscuringRects))
					...
					var rule_default = Rule,
						import_dot2 = __toESM(require_doT()),
						dotRegex = /\{\{.+?\}\}/g
								...
								_createClass(Audit, [
									...
									},
									{
										...
										value: function setAllowedOrigins(allowedOrigins) {
											...
											this.allowedOrigins = []
											var _step7,
												_iterator7 = _createForOfIteratorHelper(allowedOrigins)
											try {
									...
									},
									{
										...
										value: function run(context, options, resolve, reject) {
											...
											var allRulesToRun = (function getRulesToRun(rules, context, options) {
													var base = { now: [], later: [] }
													return rules.reduce(function (out, rule) {
					...
					function getHelpUrl(_ref102, ruleId, version) {
						var brand = _ref102.brand,
							application = _ref102.application,
							lang = _ref102.lang
						return (
					...
					function normalizeRunParams(_ref103) {
						var _ref105,
							_options$reporter,
							_axe$_audit,
							_ref104 = _slicedToArray(_ref103, 3),
							context = _ref104[0],
							options = _ref104[1],
							callback = _ref104[2],
								...
								null !==
									(_ref105 =
										null !== (_options$reporter = options.reporter) && void 0 !== _options$reporter
											...
											? void 0
											: _axe$_audit.reporter) && void 0 !== _ref105
									? _ref105
									: 'v1'),
					...
					function serializeNode(_ref108) {
						var node = _ref108.node,
							nodeResult = _objectWithoutProperties(_ref108, _excluded9)
						nodeResult.node = node.toJSON()
						for (var _i33 = 0, _arr2 = ['any', 'all', 'none']; _i33 < _arr2.length; _i33++) {
							var type = _arr2[_i33]
							nodeResult[type] = nodeResult[type].map(function (_ref109) {
								var relatedNodes = _ref109.relatedNodes
								return _extends({}, _objectWithoutProperties(_ref109, _excluded10), {
					...
					function setFrameSpec(partialResults) {
						var _step8,
							frameStack = [],
							_iterator8 = _createForOfIteratorHelper(partialResults)
						try {
							for (_iterator8.s(); !(_step8 = _iterator8.n()).done; ) {
								var partialResult = _step8.value,
					...
					function getMergedFrameSpecs(_ref112) {
						var childFrameSpecs = _ref112.frames,
							parentFrameSpec = _ref112.frameSpec
								...
								results.map(function (result) {
									for (
										...
										transformedResult[type] &&
											...
											(transformedResult[type] = transformedResult[type].map(function (_ref113) {
												var _node,
													node = _ref113.node,
													typeResult = _objectWithoutProperties(_ref113, _excluded13)
												return _extends(
													{
														node: (node =
															'function' ==
					...
					;(axe._thisWillBeDeletedDoNotUse = exposed_for_testing_default),
						...
						(axe.runPartial = function runPartial() {
							...
							return (
								...
								new Promise(function (res, rej) {
									...
									.then(function (results) {
										results = results.map(function (_ref106) {
											var nodes = _ref106.nodes,
												result = _objectWithoutProperties(_ref106, _excluded8)
											return _extends({ nodes: nodes.map(serializeNode) }, result)
										})
										var environmentData,
											frames = contextObj.frames.map(function (_ref107) {
												var node = _ref107.node
						...
						(axe.finishRun = function finishRun(partialResults) {
							...
							var _ref110 =
								...
								environmentData = _ref110.environmentData
									...
									null !==
										(_ref111 =
											...
											void 0 !== _options$reporter2
												...
												? void 0
												: _axe$_audit2.reporter) && void 0 !== _ref111
										? _ref111
										: 'v1'),
